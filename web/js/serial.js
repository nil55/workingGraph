AmCharts.AmSerialChart = AmCharts.Class({inherits: AmCharts.AmRectangularChart, construct: function (a) {
        ...
        if (!this.wheelBusy) {
            var d = this.categoryAxis, c = d.parseDates, e = d.minDuration(), f = d = 1;
            this.mouseWheelZoomEnabled ? b || (d = -1) : b && (d = -1);
            var h = this.chartData.length, n = this.lastTime, g = this.firstTime;
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if (b.parseDates && !b.equalSpacing) {
                    if (b = this.startTime, d = this.endTime, isNaN(b) || isNaN(d))
                        b = this.firstTime, d = this.lastTime
                } else if (b = this.start, d = this.end, isNaN(b) || isNaN(d))
                    b = 0, d = a;
        ...
        for (b = 0; b < a.length; b++) {
            var d = a[b], c = this.rotate;
            d.rotate = c;
            d.setOrientation(c);
            c = this.categoryAxis;
            if (!c.startOnAxis || c.parseDates)
                d.expandMinMax = !0
        }
    }, updateData: function () {
        this.parseData();
    ...
    updateScrollbars: function () {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            AmCharts.isString(d.fillToGraph) && (d.fillToGraph =
                    this.getGraphById(d.fillToGraph))
        }
    ...
    compareDepth: function (a, b) {
        ...
        for (b = 0; b < a.length; b++) {
            var d = a[b], d = AmCharts.processObject(d, AmCharts.TrendLine, this.theme);
            a[b] = d;
            d.chart = this;
        ...
        var a = 0, b = this.valueAxes.length,
                d = this.graphs.length, c, e, f = !1, h, n;
        for (n = 0; n < b; n++) {
            e = this.valueAxes[n];
            var g = e.stackType;
            if ("100%" == g || "regular" == g)
                for (f = !1, h = 0; h < d; h++)
                    c = this.graphs[h], c.tcc = 1, c.valueAxis == e && "column" == c.type && (!f && c.stackable && (a++, f = !0), (!c.stackable && c.clustered || c.newStack) && a++, c.columnIndex = a - 1, c.clustered || (c.columnIndex = 0));
            if ("none" == g || "3d" == g) {
                f = !1;
                for (h = 0; h < d; h++)
                    c = this.graphs[h], c.valueAxis == e && "column" == c.type && (c.clustered ? (c.tcc = 1, c.newStack && (a = 0), c.hidden || (c.columnIndex = a, a++)) : c.hidden || (f =
                            !0, c.tcc = 1, c.columnIndex = 0));
                f && 0 == a && (a = 1)
            }
            if ("3d" == g) {
                e = 1;
                for (n = 0; n < d; n++)
                    c = this.graphs[n], c.newStack && e++, c.depthCount = e, c.tcc = a;
                a = e
            }
        }
        return a
    ...
    handleScrollbarZoom: function (a) {
        ...
        if (this.prevStartTime != this.startTime || this.prevEndTime != this.endTime) {
            ...
            var b = this.categoryAxis,
                    d = AmCharts.extractPeriod(b.minPeriod).period, b = b.dateFormatsObject[d];
        ...
        var h = e + Math.round((f - e) / 2), n = a[h][b];
        if (1 >= f - e) {
            if (c)
                return e;
            c = a[f][b];
    ...
    formatPeriodString: function (a, b) {
        if (b) {
            var d = ["value", "open", "low", "high", "close"], c = "value open low high close average sum count".split(" "), e = b.valueAxis, f = this.chartData, h = b.numberFormatter;
            h || (h = this.nf);
            for (var n = 0; n < d.length; n++) {
                for (var g = d[n], k = 0, l = 0, m, u, w, t, p, x = 0, r = 0, A, q, v, y, C, D = this.start; D <= this.end; D++) {
                    ...
                    if (z && (z = z.axes[e.id].graphs[b.id])) {
                        if (z.values) {
                            var B = z.values[g];
                            if (this.rotate) {
                                if (0 > z.x || z.x > z.graph.height)
                                    B = NaN
                            } else if (0 > z.x || z.x > z.graph.width)
                                B = NaN;
                            if (!isNaN(B)) {
                                isNaN(m) &&
                                        (m = B);
                                ...
                                var F = AmCharts.getDecimals(B), k = k + B, k = AmCharts.roundTo(k, Math.max(p, F));
                                l++;
                                p = k / l
                            }
                        }
                ...
                x = {open: A, close: q, high: y, low: v, average: C, sum: x, count: r};
                a = AmCharts.formatValue(a, {open: m, close: u, high: t, low: w, average: p, sum: k, count: l},
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                var f = this.balloonDateFormat, h = this.chartCursor;
                h && (f = h.categoryBalloonDateFormat);
                -1 != a.indexOf("[[category]]") && (f = AmCharts.formatDate(e, f, this), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f,
                        e)), e = f)
            }
        ...
        a =
                AmCharts.formatValue(a, b.values, ["percents"], f);
...
AmCharts.Cuboid = AmCharts.Class({construct: function (a, b, d, c, e, f, h, n, g, k, l, m, u, w, t, p, x) {
        this.set = a.set();
        this.container = a;
        this.h = Math.round(d);
        this.w = Math.round(b);
        ...
        var b = this.container,
                d = b.chart, c = this.w, e = this.h, f = this.dx, h = this.dy, n = this.colors, g = this.alpha, k = this.bwidth, l = this.bcolor, m = this.balpha, u = this.gradientRotation, w = this.cornerRadius, t = this.dashLength, p = this.pattern, x = this.topRadius, r = this.bcn, A = n, q = n;
        ...
        if (0 < Math.abs(f) || 0 < Math.abs(h))
            if (isNaN(x))
                F = q, q = AmCharts.adjustLuminosity(A, -.2), q = AmCharts.adjustLuminosity(A, -.2), v = AmCharts.polygon(b, [0, f, c + f, c, 0], [0, h, h, 0, 0],
                ...
                H = E * x;
                I = G * x;
                .1 < E && .1 < E && (v = AmCharts.circle(b, E, A, g, k, l, m, !1, G), v.translate(q, M));
                .1 < H && .1 < H && (F = AmCharts.circle(b, H, AmCharts.adjustLuminosity(A, .5), g, k, l, m, !1, I), F.translate(N, O))
            }
        g = P;
        1 > Math.abs(e) && (e = 0);
        1 > Math.abs(c) && (c = 0);
        !isNaN(x) && (0 < Math.abs(f) || 0 < Math.abs(h)) ? (n = [A], n = {fill: n, stroke: l, "stroke-width": k, "stroke-opacity": m, "fill-opacity": g},
        J ? (g = "M0,0 L" + c + "," + (e / 2 - e / 2 * x), k = " B", 0 < c && (k = " A"), AmCharts.VML ? (g += k + Math.round(c - H) + "," + Math.round(e / 2 - I) + "," + Math.round(c + H) + "," + Math.round(e / 2 + I) + "," + c + ",0," + c + "," + e, g = g + (" L0," + e) + (k + Math.round(-E) + "," + Math.round(e / 2 - G) + "," + Math.round(E) + "," + Math.round(e / 2 + G) + ",0," + e + ",0,0")) : (g += "A" + H + "," + I + ",0,0,0," + c + "," + (e - e / 2 * (1 - x)) + "L0," + e, g += "A" + E + "," + G + ",0,0,1,0,0"), E = 90) : (k = c / 2 - c / 2 * x, g = "M0,0 L" + k + "," + e, AmCharts.VML ? (g = "M0,0 L" + k + "," + e, k = " B", 0 > e && (k = " A"), g += k + Math.round(c / 2 - H) + "," + Math.round(e - I) +
            ...
            0], [0, e], l, m, k, t) : 0 < w ? AmCharts.rect(b, c, e, n, g, k, l, m, w, u, t) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, e, e, 0, 0], n, g, k, l, m, u, !1, t);
        ...
        for (v = 0; v < c.length; v++)
            if (y = c[v])
                a.push(y), AmCharts.setCN(d, y, r + "element");
        p && b.pattern(p)
    }, width: function (a) {
        isNaN(a) &&
                (a = 0);
...
AmCharts.CategoryAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        this.periods = [{period: "ss", count: 1}, {period: "ss", count: 5}, {period: "ss", count: 10}, {period: "ss",
        ...
        if (AmCharts.ifArray(a)) {
            ...
            var c = this.start, e = this.labelFrequency, f = 0;
            b = this.end - c + 1;
            var h = this.gridCountR, n = this.showFirstLabel, g = this.showLastLabel, k, l = "",
                    m = AmCharts.extractPeriod(this.minPeriod);
            k = AmCharts.getPeriodDuration(m.period, m.count);
            var u, w, t, p, x, r;
            u = this.rotate;
            var A = this.firstDayOfWeek, q = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * k), this.minPeriod, 1, A).getTime(), v;
            this.endTime > a && (this.endTime = a);
            r = this.minorGridEnabled;
            var y, a = this.gridAlpha, C;
            if (this.parseDates && !this.equalSpacing) {
                this.timeDifference = this.endTime - this.startTime;
                c = this.choosePeriod(0);
                e = c.period;
                u = c.count;
                w = AmCharts.getPeriodDuration(e,
                        u);
                w < k && (e = m.period, u = m.count, w = k);
                t = e;
                "WW" == t && (t = "DD");
                this.stepWidth = this.getStepWidth(this.timeDifference);
                var h = Math.ceil(this.timeDifference / w) + 5, D = l = AmCharts.resetDateToMin(new Date(this.startTime - w), e, u, A).getTime();
                t == e && 1 == u && this.centerLabelOnFullPeriod && (x = w * this.stepWidth);
                this.cellWidth = k * this.stepWidth;
                b = Math.round(l / w);
                c = -1;
                b / 2 == Math.round(b / 2) && (c = -2, l -= w);
                var z = d.firstTime, B = 0;
                ...
                if (0 < this.gridCountR)
                    for (b = c; b <=
                        ...
                        r && this.markPeriodChange ? (r = this.dateFormatsObject[this.nextPeriod[t]], this.twoLineMode && (r = this.dateFormatsObject[t] + "\n" + r,
                                r = AmCharts.fixBrakes(r)), v = !0) : r = this.dateFormatsObject[t];
                        q || (v = !1);
                        ...
                        if (!isNaN(y))
                            for (k = 1; k < u; k += y)
                                this.gridAlpha = this.minorGridAlpha, r = m + C * k, r = AmCharts.resetDateToMin(new Date(r), e, y, A).getTime(), r = new this.axisItemRenderer(this, (r - this.startTime) * this.stepWidth),
                                        this.pushAxisItem(r);
                        this.gridAlpha = a
                    }
                ...
                if (this.cellWidth = this.getStepWidth(b), b < h && (h = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < h)
                    for (q = Math.floor(b / h), y = this.chooseMinorFrequency(q), k = f, k / 2 == Math.round(k / 2) && k--, 0 > k && (k = 0), h = 0, this.end - k + 1 >= this.autoRotateCount && (this.labelRotation = this.autoRotateAngle), b = k; b <= this.end + 2; b++) {
                        ...
                        if (r && !isNaN(y))
                            if (b / y == Math.round(b / y) || p)
                                b / q == Math.round(b /
                                        q) || p || (this.gridAlpha = this.minorGridAlpha, l = void 0);
                            else
                                continue;
                        else if (b / q != Math.round(b / q) && !p)
                            continue;
                        ...
                        v = !1;
                        this.boldLabels && (v = !0);
                        b > this.end && "start" == this.tickPosition &&
                                (l = " ");
                ...
                if (this.data[k].time != AmCharts.resetDateToMin(new Date(this.data[k].time), e, u, A).getTime())
                    for (A = 0, v = l, b = k; b < x; b++)
                        m =
                                this.data[b].time, this.checkPeriodChange(e, u, m, v) && (A++, 2 <= A && (w = b, b = x), v = m);
                ...
                if (0 < this.gridCountR)
                    for (b = k; b < x; b++)
                        if (m = this.data[b].time, this.checkPeriodChange(e, u, m, l) && b >= w) {
                            ...
                            l = AmCharts.formatDate(new Date(m),
                                    r, d);
                            if (b == c && !n || b == h && !g)
                                l = " ";
                            ...
                            isNaN(y) || (this.checkPeriodChange(e, y, m, D) && (this.gridAlpha = this.minorGridAlpha, k = this.getCoordinate(b -
                                    this.start), r = new this.axisItemRenderer(this, k), this.pushAxisItem(r), D = m), this.gridAlpha = a)
            }
            for (b = 0; b < this.data.length; b++)
                if (n = this.data[b])
                    g = this.parseDates && !this.equalSpacing ? Math.round((n.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - f), n.x[this.id] = g;
            n = this.guides.length;
            for (b = 0; b < n; b++)
                g = this.guides[b], q = q = q = a = c = NaN, y = g.above, g.toCategory && (q = d.getCategoryIndexByValue(g.toCategory), isNaN(q) || (c = this.getCoordinate(q - f), g.expand && (c += this.cellWidth / 2), p = new this.axisItemRenderer(this,
                        ...
                        a, g.label, !1, NaN, q, g), this.pushAxisItem(p, y)), (0 < c || 0 < a) && (c < this.width || a < this.width) && (c = new this.guideFillRenderer(this, a, c, g), a = c.graphics(), this.pushAxisItem(c, y), g.graphics = a, a.index = b, g.balloonText && this.addEventListeners(a, g))
        }
        this.axisCreated = !0;
        d = this.x;
        f = this.y;
        ...
        2 < d - this.previousHeight && this.autoWrap && !this.parseDates && (this.axisCreated = this.chart.marginsUpdated =
                !1);
        ...
        var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[a].count), d = Math.ceil(this.timeDifference / b), c = this.periods;
    ...
    getCoordinate: function (a) {
        ...
        d = new Date(d);
        var f = new Date(c), h = this.firstDayOfWeek;
        c = b;
        "DD" == a && (b = 1);
        d = AmCharts.resetDateToMin(d, a, b, h).getTime();
        b = AmCharts.resetDateToMin(f, a, b, h).getTime();
        return"DD" == a && "hh" !=
                e && d - b <= AmCharts.getPeriodDuration(a, c) ? !1 : d != b ? !0 : !1
        ...
        var b = this.data, d = this.chart, c = d.rotate, e = this.stepWidth;
        this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(a / e) - this.minDuration() / 2, d = d.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= e / 2), d = this.start + Math.round(a /
                e));
        var d = AmCharts.fitToBounds(d, 0, b.length - 1), f;
        b[d] && (f = b[d].x[this.id]);
        ...
        return this.chart ? (a =
                this.chart.getCategoryIndexByValue(a), this.getCoordinate(a - this.start)) : NaN
